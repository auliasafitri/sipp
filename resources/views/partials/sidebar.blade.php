...
<div class="left-side-bar">
	<div class="brand-logo">
		<a href="index.html">
			...
			<img
				src="{{ asset('vendors/images/logo_koperasi.png') }}"
				alt=""
				class="light-logo"
			/>
		</a>
			...
			<ul id="accordion-menu">
				...
				<li class="dropdown">
					<a href="javascript:;" class="dropdown-toggle">
						<span class="micon bi bi-clipboard"></span
					...
					<a href="/siswa" class="dropdown-toggle no-arrow">
						...
						><span class="mtext">Akun</span>
					</a>
				</li>
				<li class="">
					<a href="/adm_guru" class="dropdown-toggle no-arrow">
						<span class="micon bi bi-boxes"></span
						><span class="mtext">Stok</span>
					</a>
				</li>
				<li class="">
				...
				<li class="">
					<a href="/DetailTransaksi" class="dropdown-toggle no-arrow">
						...
						><span class="mtext">Detail Transaksi</span>
					</a>
				</li>
